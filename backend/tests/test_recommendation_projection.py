...
class RecommendationProjectionTest(unittest.TestCase):
    ...
    def test_latest_records_picks_latest_generated(self):
        ...
        older = self.make_rec(
            gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ), rec_id=1, score=70
        )
        newer = self.make_rec(
            gen_at=datetime(2026, 9, 3, 10, 0, tzinfo=TZ), rec_id=2, score=90
        )
    ...
    def test_latest_records_different_symbols_independent(self):
        ...
        a1 = self.make_rec(
            symbol="BBCA", gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ), rec_id=1
        )
        a2 = self.make_rec(
            symbol="BBCA", gen_at=datetime(2026, 9, 3, 10, 0, tzinfo=TZ), rec_id=2
        )
        b1 = self.make_rec(
            symbol="BBRI", gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ), rec_id=3
        )
    ...
    def test_current_records_prefers_live_over_preview(self):
        ...
        preview = self.make_rec(
            status="PREVIEW",
            cycle="preview",
            gen_at=datetime(2026, 9, 3, 10, 0, tzinfo=TZ),
            rec_id=1,
        )
        live = self.make_rec(
            status="ACTIVE",
            cycle="daily",
            gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ),
            rec_id=2,
        )
    ...
    def test_current_records_live_beats_newer_preview(self):
        ...
        old_live = self.make_rec(
            status="ACTIVE",
            cycle="daily",
            gen_at=datetime(2026, 9, 3, 8, 0, tzinfo=TZ),
            rec_id=1,
        )
        new_preview = self.make_rec(
            status="PREVIEW",
            cycle="preview",
            gen_at=datetime(2026, 9, 3, 10, 0, tzinfo=TZ),
            rec_id=2,
    ...
    def test_current_records_different_methods_independent(self):
        ...
        paper = self.make_rec(
            method="PAPER_TRADE", gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ), rec_id=2
        )
    ...
    def test_current_records_preview_in_cycle_name(self):
        ...
        preview_cycle = self.make_rec(
            status="ACTIVE",
            cycle="night-preview",
            gen_at=datetime(2026, 9, 3, 10, 0, tzinfo=TZ),
            rec_id=1,
        )
        live_cycle = self.make_rec(
            status="ACTIVE",
            cycle="daily",
            gen_at=datetime(2026, 9, 3, 9, 0, tzinfo=TZ),
            rec_id=2,
