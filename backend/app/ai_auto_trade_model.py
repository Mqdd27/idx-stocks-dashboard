...
class AIAutoTradeConfig(Base):
    ...
    quick_model: Mapped[str] = mapped_column(
        String(128), default="cx/gpt-5.4-mini", nullable=False
    )
    deep_model: Mapped[str] = mapped_column(
        String(128), default="cx/gpt-5.5", nullable=False
    )
